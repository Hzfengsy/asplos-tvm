            ...
            for bx in T.thread_binding(256, thread="blockIdx.x"):
                for ty in T.thread_binding(4, thread="threadIdx.y"):
                    with T.block():
                        ...
                        for i2_0_0 in T.serial(128, annotations={"software_pipeline_order":[0, 3, 1, 4, 5, 2, 6], "software_pipeline_stage":[0, 0, 0, 0, 0, 1, 1]}):
                            with T.block():
                                ...
                                for i2_0_1 in T.serial(4, annotations={"software_pipeline_order":[0, 1, 2], "software_pipeline_stage":[0, 0, 1]}):
                                    with T.block():
