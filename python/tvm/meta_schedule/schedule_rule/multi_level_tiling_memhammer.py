...
# under the License.
"""Multi-level tiling with reuse (using MemHammer)."""
...
@register_object("meta_schedule.MultiLevelTilingMemHammer")
class MultiLevelTilingMemHammer(ScheduleRule):
    """Multi-level tiling with data reuse for MemHammer
    ...
    def __init__(
        ...
        self.__init_handle_by_constructor__(
            _ffi_api.ScheduleRuleMultiLevelTilingMemHammer,  # type: ignore # pylint: disable=no-member
            structure,
            tile_binds,
            use_tensor_core,
            add_local_stage,
